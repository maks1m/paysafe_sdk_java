...
public class DirectDebitService {
     ...
     * @throws PaysafeException the paysafe exception
     */
    public final Purchases submitPurchase(Purchases purchases)
    throws IOException, PaysafeException {
        final Request request = Request.builder()
    ...
    public final Purchases cancelPurchase(Purchases purchases)
    throws IOException, PaysafeException {
        final Request request = Request.builder()
     ...
     * @throws PaysafeException the paysafe exception
     */
    public final Purchases getPurchase(Purchases purchases)
    throws IOException, PaysafeException {
        final Request request = Request.builder()
                .uri(prepareUri(ACCOUNTS + client.getAccount() + PURCHASE_PATH + purchases.getId()))
                .method(Request.RequestType.GET)
     ...
     * @throws PaysafeException the paysafe exception
     */
    public final StandaloneCredits submitStandaloneCredit(StandaloneCredits standalonecredits)
    throws IOException, PaysafeException {
        final Request request = Request.builder()
    ...
    public final StandaloneCredits cancelStandaloneCredit(StandaloneCredits standalonecredits)
    throws IOException, PaysafeException {
        final Request request = Request.builder()
     ...
     * @throws PaysafeException the paysafe exception
     */
    public final StandaloneCredits getStandaloneCredit(StandaloneCredits standalonecredits)
    throws IOException, PaysafeException {
        final Request request = Request.builder()
                .uri(prepareUri(ACCOUNTS + client.getAccount() + CREDIT_REQUEST_PATH + standalonecredits.getId()))
                .method(Request.RequestType.GET)
